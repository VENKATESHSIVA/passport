  ...
  stages {
    ...
    stage('Deploy to artifactory'){
        ...
        post {  
         ...
         failure {  
             mail bcc: '', body: "<b>Example</b><br>Project: ${env.JOB_NAME} <br>Build Number: ${env.BUILD_NUMBER} <br> URL de build: ${env.BUILD_URL}", cc: '', charset: 'UTF-8', from: 'venkateshshiva12345@gmail.com', mimeType: 'text/html', replyTo: '', subject: "ERROR CI: Project name -> ${env.JOB_NAME}", to: "venkateshshiva12345@gmail.com";  
         }  
         unstable {  
